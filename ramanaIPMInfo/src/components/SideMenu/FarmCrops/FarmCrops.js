                        ...
                        <View style={{
                            ...
                            <View style={{ width: wp('100%') }}>
                                <View style={{ width: wp('20%'), height: hp('7%'), justifyContent: 'center', opacity: 0.8 }}>
                                    <Image style={{ position: 'absolute', width: 50, height: 30, top: hp('2%') }} source={require('../../../../assets/images/strawberry.jpg')} />
                                    <Text style={{ top: hp('2%'), left: wp('35%'), width: wp('29%'), position: 'absolute', fontWeight: 'bold', fontSize: wp('4.5%'), color: '#ffffff' }}>{I18n.t('MORE_DETAILS')}</Text>
                                </View>
                                <TouchableOpacity onPress={() => navigateToNextScreen()} style={{ position: 'absolute', top: hp('1.5%'), left: wp('90%') }}>
